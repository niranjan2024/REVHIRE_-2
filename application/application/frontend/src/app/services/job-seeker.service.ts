...
export class JobSeekerService {
  ...
  applyToJob(jobId: number): Observable<{ message: string }> {
    return this.http.post<{ message: string }>(`${this.baseUrl}/jobseeker/jobs/${jobId}/apply`, {}, { withCredentials: true });
  }
  ...
  withdrawApplication(jobId: number): Observable<{ message: string }> {
    return this.http.post<{ message: string }>(`${this.baseUrl}/jobseeker/jobs/${jobId}/withdraw`, {}, { withCredentials: true });
  }

  withdrawApplicationById(applicationId: number): Observable<{ message: string }> {
    return this.http.post<{ message: string }>(`${this.baseUrl}/jobseeker/jobs/applications/${applicationId}/withdraw`, {}, { withCredentials: true });
  }
