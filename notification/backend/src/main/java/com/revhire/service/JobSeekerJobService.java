...
public class JobSeekerJobService {
    ...
    @Transactional
    public void applyToJob(String username, Long jobId) {
        User jobSeeker = getJobSeeker(username);
        ...
        if (existing != null) {
            ...
            notifyEmployerOnApply(existing);
            notifySeekerOnApply(existing);
            return;
        }
    ...
    @Transactional
    public void withdrawApplication(String username, Long jobId) {
        User jobSeeker = getJobSeeker(username);
    ...
    @Transactional
    public void withdrawApplicationById(String username, Long applicationId) {
        User jobSeeker = getJobSeeker(username);
    ...
    private void notifyEmployerOnApply(JobApplication application) {
        ...
        notificationService.createNotification(employer, application.getJob(), message);
    }
    ...
    private void notifySeekerOnApply(JobApplication application) {
        ...
        notificationService.createNotification(seeker, application.getJob(), message);
    }
}
